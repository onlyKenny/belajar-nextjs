...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, faMountainCity, faCity, faRainbow} from '@fortawesome/free-solid-svg-icons'
...
const DefaultLayout: React.FC<{
    ...
    function getMenu(): MenuProps['items'] {
        ...
        menu.push({
            key: '/brand',
            label: 'Manage Brand',
            icon: <FontAwesomeIcon icon={faRainbow}></FontAwesomeIcon>,
